    ...
    return function(modules) {
        ...
        var FunnelD3Item = function(_super) {
            ...
            FunnelD3Item.prototype._updateExportingImage = function() {
                var svg = this.$funnelContainer.children()[0], str = new XMLSerializer().serializeToString(svg), encodedData = "data:image/svg+xml;base64," + window.btoa(window["unescape"](encodeURIComponent(str)));
